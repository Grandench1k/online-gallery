...
public interface UserController {
    ...
    @Operation(summary = "GET profile image", description = "GET profile image by userId",
            responses = {
                    ...
                    @ApiResponse(responseCode = "404", description = "Not found any profile images.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = NotFoundExceptionResponse.class)))})
    ...
    @Operation(summary = "POST profile image", description = "POST profile image by userId",
            responses = {
                    ...
                    @ApiResponse(responseCode = "400", description = "Incorrect profile image format, please send image with .jpg, .png, .webp and .jpeg formats.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = BadRequestExceptionResponse.class)))})
    ...
    @Operation(summary = "UPDATE password", description = "UPDATE user password",
            responses = {
                    @ApiResponse(responseCode = "200", content = @Content(mediaType = "application/json", schema = @Schema(implementation = OkResponse.class))),
                    @ApiResponse(responseCode = "400", description = "Invalid old password", content = @Content(mediaType = "application/json", schema = @Schema(implementation = BadRequestExceptionResponse.class))),
                    @ApiResponse(responseCode = "400", description = "passwords match.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = BadRequestExceptionResponse.class)))})
