...
public interface VideoController {
    @Operation(summary = "GET all videos", description = "GET all videos by userId",
            responses = {
                    ...
                    @ApiResponse(responseCode = "404", description = "Videos not found.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = NotFoundExceptionResponse.class)))})
    ...
    @Operation(summary = "GET video by Id", description = "GET video by Id and UserId",
            responses = {
                    ...
                    @ApiResponse(responseCode = "404", description = "Video with this id not found.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = NotFoundExceptionResponse.class)))})
    ...
    @Operation(summary = "POST video", description = "POST video by userId",
            responses = {
                    @ApiResponse(responseCode = "200", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Video.class))),
                    @ApiResponse(responseCode = "400", description = "Incorrect video format, please send video with .mp4, .mpeg and .ogg formats.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = BadRequestExceptionResponse.class))),
                    @ApiResponse(responseCode = "409", description = "Video with this name is already defined.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = NotFoundExceptionResponse.class)))})
    ...
    @Operation(summary = "UPDATE video by Id", description = "UPDATE video by Id and UserId",
            responses = {
                    @ApiResponse(responseCode = "200", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Video.class))),
                    @ApiResponse(responseCode = "404", description = "Video with this id not found.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = NotFoundExceptionResponse.class))),
                    @ApiResponse(responseCode = "409", description = "Video with this name is already defined.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = BadRequestExceptionResponse.class)))})
