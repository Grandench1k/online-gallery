package com.online.gallery.controller.image;
...
public interface ImageController {
    @Operation(summary = "GET all images", description = "GET all images by userId",
            responses = {
                    ...
                    @ApiResponse(responseCode = "404", description = "Images not found.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = NotFoundExceptionResponse.class)))})
    ...
    @Operation(summary = "GET image by Id", description = "GET image by Id and UserId",
            responses = {
                    ...
                    @ApiResponse(responseCode = "404", description = "Image with this id not found.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = NotFoundExceptionResponse.class)))})
    ...
    @Operation(summary = "POST image", description = "POST image by userId",
            responses = {
                    @ApiResponse(responseCode = "200", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Image.class))),
                    @ApiResponse(responseCode = "400", description = "Incorrect image format, please send image with .jpg, .jpeg, .png, .webp, .bmp, .gif and .tiff formats.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = BadRequestExceptionResponse.class))),
                    @ApiResponse(responseCode = "409", description = "Image with this name is already defined.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = BadRequestExceptionResponse.class)))})
    ...
    @Operation(summary = "UPDATE image by Id", description = "UPDATE image by Id and UserId",
            responses = {
                    @ApiResponse(responseCode = "200", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Image.class))),
                    @ApiResponse(responseCode = "404", description = "Image with this id not found.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = BadRequestExceptionResponse.class))),
                    @ApiResponse(responseCode = "409", description = "Image with this name is already defined.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = BadRequestExceptionResponse.class)))})
